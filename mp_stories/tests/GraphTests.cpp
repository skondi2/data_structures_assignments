...
Graph<Vertex, Edge> createTestGraph() {
  ...
  */
  ...
  g.insertEdge("a", "c");
  //std::cout << "inserting a-d" << std::endl;
  g.insertEdge("a", "d");

  // Additional edges on `b`:
  //std::cout << "inserting b-c" << std::endl;
  g.insertEdge("b", "c");

  // Additional edges on `c`:
  //std::cout << "inserting c-e" << std::endl;
  g.insertEdge("c", "e");
  //std::cout << "inserting c-h" << std::endl;
  g.insertEdge("c", "h");

  // Additional edges on `d`:
  //std::cout << "inserting d-e" << std::endl;
  g.insertEdge("d", "e");

  // Additional edges on `e`: (none)

  // Additional edges on `f`:
  //std::cout << "inserting f-g" << std::endl;
  g.insertEdge("f", "g");

  // Additional edges on `g`:
  //std::cout << "inserting g-h" << std::endl;
  g.insertEdge("g", "h");

...
class BinaryTree
{
    public:
        ...
        /**
          Helper function to switch the right and left contents of a subroot
        */
        ...
        bool isOrderedIterativeHelper(Node* root) const;
        ...
        void getPaths(std::vector<std::vector<T>>& paths, Node* subRoot, std::vector<T> pathVec) const;
        ...
        int sumDistancesHelper(Node* subRoot, int dist) const;

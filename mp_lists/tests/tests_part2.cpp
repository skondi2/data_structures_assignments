...
TEST_CASE("Custom made reverse test", "[weight=1][part=2][valgrind]") {
  List<int> list;
  List<int> requireList;

  requireList.insertBack(4);
  requireList.insertBack(2);
  requireList.insertBack(3);
  requireList.insertBack(1);
...
TEST_CASE("Custom made merge test", "[weight=1][part=2][valgrind]") {
  List<int> list;
  List<int> requireList;
